#+======================================================================
# $HeadURL: https://svnpub.codac.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/branches/codac-core-6.1/src/main/resources/util.sh $
# $Id: util.sh 96475 2019-01-09 13:47:38Z sivecm $
#
